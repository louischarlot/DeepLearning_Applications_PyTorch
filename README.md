...
* [Image classification](https://github.com/louischarlot/DeepLearning_Applications_PyTorch/blob/main/CNN/Image_classification.ipynb): We implement a CNN classification of the images from the CIFAR10 dataset.
